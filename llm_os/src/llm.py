import json
import httpx
from typing import Optional, Any, Dict, List, Union, Iterator, Callable, Tuple
from pydantic import BaseModel, ConfigDict
from src.utils import logger, Timer, get_function_call, get_function_call_for_tool_call
from src.tools import Tool, Toolkit, Function, FunctionCall
try:
